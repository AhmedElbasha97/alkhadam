...
import 'package:alkhadam/features/companies/company_details/presentation/company_details_screen.dart';
...
class CompanyDetailsCubit extends Cubit<CompanyDetailsState> {
  ...
  Future<void> showSignInSignUpDialog({
    ...
    AwesomeDialog(
        ...
        btnOkColor:  AppTheme.brandColor,
        btnCancelColor:  AppTheme.brandColor,
