...
class BookingServices{
  ...
  Future<BookingPriceModel?> checkingPricesOfBooking({String? workerId,String? date,String? workerNo,String? hoursNo,String? arrivalTime,String? services}) async {

    final resp = await api.post(ApiConstant.checkingPricesOfBookingLink,data:{
      "worker_id": workerId,
      "date": date,
      "workers_no": workerNo,
      "hours_no": hoursNo,
